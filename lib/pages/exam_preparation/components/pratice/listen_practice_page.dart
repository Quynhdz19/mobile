...
class ListenPracticePage extends StatefulWidget {
  const ListenPracticePage({Key? key, required this.title, required this.jsonPath})
      : super(key: key);
  ...
  @override
  State<ListenPracticePage> createState() => _ListenPracticePageState();
}

class _ListenPracticePageState extends State<ListenPracticePage> {
