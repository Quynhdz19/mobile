...
class PracticeOption extends StatelessWidget {
  PracticeOption({Key? key, required this.choice,
    required this.index,
    required this.press,  required this.answer, required this.selected, required this.indexQs}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return GetBuilder<PracticeController>(
        ...
        builder: (qnController) {
          ...
          // Color getTheRight() {
          //   if(_practiceController.components[indexQs].questions[])
          // }
          return Option(choice: choice, press: press, color: getTheRightColor());
