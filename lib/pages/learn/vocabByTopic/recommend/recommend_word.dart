...
class RecommendWord extends StatefulWidget {

  RecommendWord({Key? key, required this.id}) : super(key: key);
  final String id;

  @override
  _RecommendWord createState() => _RecommendWord();
}
class _RecommendWord extends State<RecommendWord> {
