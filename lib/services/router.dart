...
import '../pages/exam_preparation/ielts/component/i_litsent.dart';
...
Route<dynamic> generateRoute(RouteSettings settings) {
  switch (settings.name) {
    ...
    case routes.I_Listening:
      return MaterialPageRoute(builder: (context) => I_Lisening(title: 'oki', jsonPath: 'assets/data/practice_part2.json',));
